...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'Kontrol Edilmeli',
        empty           : 'Boş Bırakmayınız',
        min             : 'Değer çok kısa',
        max             : 'Değer çok uzun',
        number_min      : 'Çok küçük değer',
        number_max      : 'Çok büyük değer',
        url             : 'yanlış adres formatı',
        number          : 'Bu bir sayı değil',
        email           : 'Eposta adresi geçersiz',
        email_repeat    : 'Epostalar uyuşmuyor',
        password_repeat : 'Şifreler uyuşmuyor',
        repeat          : 'eşleşmedi',
        complete        : 'Girdi tamamlanmadı',
        select          : 'Lütfen birini seçin'
    };
